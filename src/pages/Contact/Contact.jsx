    ...
    <div className='home-bg'>
      <div className="container my-24 mx-auto md:px-6">
        <div className="flex flex-wrap justify-center gap-6 items-center">
          <div className="bg-blue-400/70 p-10 rounded-xl">
          ...
          <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <div className="max-w-xl mx-auto">
              <div className="text-center">
                <h4 className="text-lg  font-custom text-blue-800 dark:text-white">
                  Send us a message
                </h4>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="py-3 px-4 block w-full border-b-2 border-blue-500  text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                        />
                      </div>
            ...
            <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 lg:gap-8">
              ...
              >
                <svg
                  className="w-9 h-9 text-blue-800 mx-auto dark:text-gray-200"
